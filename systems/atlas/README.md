...
Atlas provides authoritative storage for Pantheon.

## Role

Unraid NAS and source of truth for persistent user, media, backup, application, and scan data.

## Responsibilities

- Store persistent data.
- Serve data to users and compute systems.
- Host data-adjacent services where documented.
- Provide NFS/SMB exports for compute nodes.
- Protect authoritative data.

## Explicit Non-Responsibilities

- Do not route or firewall traffic.
- Do not host AI workloads.
- Do not host heavy compute workloads.
- Do not become a dependency for Prometheus bootstrapping.

## Network Placement

Atlas is documented on the SERVERS VLAN for services and storage access, with MGMT reserved for administrative access.

## Data Ownership

Atlas owns authoritative storage. Runtime compute and disposable caches belong elsewhere.
...
- [[systems/atlas/procedures/nextcloud-reverse-proxy]]
- [[systems/atlas/procedures/atlas-recovery]]
- [[systems/atlas/procedures/share-audit]]
- [[systems/atlas/procedures/nextcloud-deployment]]
- [[systems/atlas/procedures/nextcloud-external-storage]]
- [[systems/atlas/procedures/nextcloud-ext-storage-validation]]
...
Atlas documents storage authority, shares, cache policy, service data paths, backup and recovery posture, and validation without putting authoritative data at risk.

## What To Avoid

- Do not automate storage layout before backup and restore are proven.
- Do not treat Docker or cache-layer state as authoritative.
- Do not host heavy compute or AI workloads.

## Existing System Notes

Original pre-migration note preserved:
...
I have kept decisions explicit, added missing sections, and avoided future-phase creep.
```
