...
- User-facing AI surfaces should be exposed through [[systems/prometheus/opt/stacks/ingress/traefik/traefik]] where approved.
...
- [[systems/prometheus/opt/stacks/ai/core/comfyui/comfyui]] - node-based image and media generation
- [[systems/prometheus/opt/stacks/ai/core/llamacpp/llamacpp]] - local GGUF runtime and active llama.cpp router
- [[systems/prometheus/opt/stacks/ai/core/llama-swap/llama-swap]] - OpenAI-compatible model switching proxy for llama.cpp-compatible backends
- [[systems/prometheus/opt/stacks/ai/core/ollama/ollama]] - local LLM runtime and inference API
- [[systems/prometheus/opt/stacks/ai/core/openwebui/openwebui]] - human-facing UI for LLM interaction
- [[systems/prometheus/opt/stacks/ai/searxng/searxng]] - local metasearch service intended for OpenWebUI web-search tooling
...
- [[systems/prometheus/opt/stacks/ai/voice-agent/voice-agent]] - planned Pipecat-based realtime voice interface beside [[systems/prometheus/opt/stacks/ai/core/openwebui/openwebui]]
