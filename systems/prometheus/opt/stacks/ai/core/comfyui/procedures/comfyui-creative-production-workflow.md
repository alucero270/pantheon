...
This procedure is a beginner entrypoint for using [[systems/prometheus/opt/stacks/ai/core/comfyui/comfyui]] on [[systems/prometheus]] to produce creative assets:
...
```text
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_flowers_embedded_ui.json
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_flowers_embedded_api.json
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_flowers_udq4ks_ui.json
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_flowers_udq4ks_api.json
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_flowers_udq4ks_smoke_api.json
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/unsloth_ltx23_high_action_max_udq4ks_api.json
```
...
```text
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/ltx23_gguf_kj_lora_clean_api.json
```
...
```text
systems/prometheus/opt/stacks/ai/core/comfyui/procedures/workflows/comfyui/video_ltx2_i2v_distilled.json
```
