...
- Direct host port exposure (`0.0.0.0:3000`) circumvents the Traefik-only access model. `homelable.home.arpa` should be routed through Traefik and the host port removed, following `Phase 13` in [[systems/prometheus/procedures/reverse-proxy]].
...
- Services: [[systems/prometheus/services/traefik]]
- Architecture: [[systems/prometheus/architecture/compose-registry]]
- Procedures: [[systems/prometheus/procedures/reverse-proxy]], [[systems/prometheus/procedures/reverse-proxy-validation]]
