# Remote Access VPN — Tailscale (Current State)
...
Planned follow-ups:
- `systems/network/procedures/management-access-jump-host.md`
- `decisions/adr-jump-host-model.md`
- (Optional) `systems/network/procedures/media-egress-airvpn.md`
